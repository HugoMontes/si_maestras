...
class Especialista_trabajador_especialidad_model extends CI_Model{

	protected $table_name = 'especialista_trabajador_especialidad';
    ...
    public function delete_id_especialista($especialista_id){
        $this->db->where('id_trabajador', $especialista_id);
        return $this->db->delete($this->table_name);
    }    
