<?php
class Testimonio_personal extends CI_Controller{
    ...
    public function nuevo()
    {
        ...
        $this->load->view('backend/testimonio_personal_nuevo',$data);
    }
    ...
    public function editar($testimonio_id = FALSE)
    {
        ...
        $this->load->view('backend/testimonio_personal_editar',$data);
    }
            ...
            else
            {
                ...
                if($sw == 1)
                {
                    ...
                    {                                            
                        ...
                        redirect('administrador/testimonio_personal/editar/'.$testimonio_id);                       
                    }
                    ...
                    if($guardar == EDICION)
                    {
                        ...
                        {
                            redirect('administrador/testimonio_personal/nuevo');
                        }    
                    }                        
                }                                      
			}
