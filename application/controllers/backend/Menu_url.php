<?php
    class Menu_url extends CI_Controller{
        ...
        public function nuevo()
        {
            ...
            $this->load->view('backend/menu_url_nuevo',$data);
        }
        ...
        public function editar($menu_id = FALSE)
        {
            ...
            $this->load->view('backend/menu_url_editar',$data);
        }
        ...
        public function guardar()
    	{
    		...
    		{    		    
                ...
                $this->form_validation->set_rules('enlace', 'Enlace', 'trim|required');
                ...
                else
                {
                    ...
                    {                                            
                        ...
                        redirect('administrador/menu_url/editar/'.$menu_hijo['id']);
                    ...
                    if($guardar == EDICION)
                    {
                        ...
                        {       
                            ...
                            if($error == 0)
                            {
                                ...
                                $this->session->set_flashdata('mensaje', $this->lang->line('score_menu_guardado'));
                                //$this->editar($menu_id);
                                redirect('administrador/menu_url/editar/'.$menu_id);
                            }                      
                        }
                        else
                        {
                            redirect('administrador/menu_url/nuevo');
                        }    
                    }
    			}
    		}
