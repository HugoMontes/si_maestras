...
class Encuesta extends CI_Controller{
    ...
    public function __construct(){
        ...
        //existe_sesion_urse(); 
        // modelos
        $this->load->model('cuestionario_pregunta_model');
    ...
    public function index(){
        ...
        $navegacion = $this->navegacion_model->get_values('id',array('vista'=>ENCUESTA)); 
        ...
        */
        ...
        $data['preguntas'] = $this->cuestionario_pregunta_model->get_all('',array(),'','','orden','');
        if($usuario_sesion->centro_formacion==0){
            $data['respuestas'] = $this->cuestionario_respuesta_model->get_all('',array('id_pregunta'=>3),'','','id','');
        }else{
            $data['respuestas'] = $this->cuestionario_respuesta_model->get_all('',array('id_pregunta'=>2,'res_b'=>$usuario_sesion->centro_formacion),'','','id','');
        }
        ########################################################################################  
        $data['titulo'] = 'RESULTADOS ENCUESTA';
        $this->load->view('backend/encuesta',$data);
    }
    ...
    public function existe($especialista_id = FALSE){
        $navegacion = $this->navegacion_model->get_values('navegacion',array('vista'=>ENCUESTA));
