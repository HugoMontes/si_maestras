              ...
              <div class="row">
                ...
                <!-- fin cuadro mensaje  -->                
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form id="form-menu" role="form"  method="post" action="<?php echo base_url('index.php/administrador/menu_url/guardar');?>">
                          <div class="box-body">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tipo_nombre" name="tipo_nombre" value="<?php echo $this->lang->line('score_menu_tipo_url');?>" disabled="disabled"/>
                            ...
                            <div class="form-group">
                              <label for="enlace">Enlace <span class="required">*</span></label>
                              <?php echo form_error('enlace', '<span class="error-form">', '</span><br/><br/>'); ?>
                              <div class="row">
                                  <div class="col-lg-6">                   
                                    <input type="text" class="form-control" id="enlace" name="enlace" value="<?php echo set_value('enlace',$menu->enlace);?>" placeholder="Ingrese la url"/>
                                  </div>
                              </div>               
                            </div>  
