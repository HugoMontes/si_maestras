                        ...
                        <form id="form-menu" role="form"  method="post" action="<?php echo base_url('index.php/administrador/menu_pagina/guardar');?>">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="hidden" class="form-control" id="pagina_id" name="pagina_id" value="<?php echo set_value('pagina_id');?>"/>
                              <input type="hidden" class="form-control" id="pagina_tipo" name="pagina_tipo" value="<?php echo set_value('pagina_tipo',PAGINA_CREADA);?>"/> 
                              <div class="row">
                                  <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="pagina_nombre" name="pagina_nombre" value="<?php echo set_value('pagina_nombre','Seleccionar una página');?>" readonly="readonly" />
                                        <span class="input-group-btn">
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">                   
                                    <input type="text" class="form-control" id="enlace" name="enlace" value="<?php echo set_value('enlace');?>" placeholder="El enlace estará disponible después de guardar" readonly="readonly"/>
