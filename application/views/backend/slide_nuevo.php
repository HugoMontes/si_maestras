    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_slide_nuevo_titulo'); ?>
                <small></small>
              </h1>
            </section>
                        ...
                        <form role="form" enctype="multipart/form-data"  method="post" action="<?php echo base_url('index.php/administrador/slide/guardar');?>">
                          <div class="box-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" name="url_video" id="url_video" value="<?php echo set_value('url_video');?>" placeholder="https://www.youtube.com/watch?v=XXXX  ó  https://vimeo.com/XXXX"/>
