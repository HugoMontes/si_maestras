                    ...
                    <!-- form start -->
                        <form id="form-testimonio" role="form" enctype="multipart/form-data"  method="post" action="<?php echo base_url('index.php/administrador/testimonio_empresa/guardar');?>">
                          <div class="box-body">
                            ...
                            {
                                $label_imagen = 'Cambiar imagen destacada';  
                            ?>
                            <div class="form-group">
                            ...
                            {
                                $label_imagen = 'Imagen destacada';
                            }
                            ?>
                                                                         
                            <div class="form-group">
                              <label for="imagen"><?php echo $label_imagen; ?> </label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">  
                                    <input type="text" class="form-control" name="url_video" id="url_video" value="<?php echo set_value('url_video', $testimonio->url_video);?>" placeholder="https://www.youtube.com/watch?v=XXXX"/>
