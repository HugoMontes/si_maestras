    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_pagina_editar_titulo'); ?>                
                  ...
                  <div class="box box-primary">
                    ...
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">  
                                <input type="text" class="form-control input-large-text" id="titulo" name="titulo" value="<?php echo set_value('titulo',$pagina->titulo); ?>" placeholder="Ingrese el título"/>
                            </div>
                        </div>        
                      </div>   
                     ...
                     <div class="form-group">
                       ...
                       <div class="row">
                           <div class="col-lg-6">                   
                             <input type="text" class="form-control" id="alias" name="alias" value="<?php echo set_value('alias',$pagina->alias);?>" placeholder="Generar automáticamente desde el título"/>
                     ...
                     <!-- Inicio editor -->
                      <div class="form-group">
                        ...
                        <textarea name="contenido" id="contenido"><?php echo set_value('contenido', $pagina->contenido);?></textarea>
                      </div> 
                     <!-- Fin editor -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-lg-6"> 
                             <textarea class="form-control" rows="2" name="metadescripcion" id="metadescripcion"><?php echo set_value('metadescripcion', $pagina->metadescripcion);?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                           <div class="col-lg-6"> 
                             <textarea class="form-control" rows="2" name="metapalabras_clave" id="metapalabras_clave"><?php echo set_value('metapalabras_clave',$pagina->metapalabras_clave);?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-3">  
                        <?php
                        if(set_value('estado', $pagina->estado) == PUBLICADO)
                            $class = 'btn-success';
                        else
                            $class='btn-danger'; 
                        ...
                        $opciones = array(
                         ...
                         echo form_dropdown($data, $opciones, set_value('estado', $pagina->estado));
                    ...
                    <input type="hidden" name="pagina_id" id="pagina_id" value="<?php echo $pagina->id;?>" />
