      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p><a href="javascript:testimonio_empresa_editar('<?php echo base_url('index.php/administrador/testimonio_empresa/editar/');?>')"><?php echo $this->lang->line('score_testimonio_tipo_empresa');?></a></p>
            <p><a href="javascript:testimonio_personal_editar('<?php echo base_url('index.php/administrador/testimonio_personal/editar/');?>')"><?php echo $this->lang->line('score_testimonio_tipo_personal'); ?></a></p>
          </div>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_testimonio_editar_titulo'); ?>
              ...
              <div class="row">
                ...
                <!-- fin cuadro mensaje  -->                
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form id="form-testimonio" role="form" enctype="multipart/form-data"  method="post" action="<?php echo base_url('index.php/administrador/testimonio_personal/guardar');?>">
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">  
                                    <input type="text" class="form-control input-large-text" id="titulo" name="titulo" value="<?php echo set_value('titulo', $testimonio->titulo);?>" placeholder="Ingrese el título"/>
                                  </div>
                              </div>       
                            </div>
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tipo_nombre" name="tipo_nombre" value="<?php echo $this->lang->line('score_testimonio_tipo_personal');?>" disabled="disabled"/>
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="contenido" id="contenido"><?php echo set_value('contenido', $testimonio->contenido);?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="margin-bottom">
                                  <img class="img-responsive img-centro" src="<?php echo base_url('assets/img/testimonios/'.$testimonio->imagen); ?>" alt="<?php echo $testimonio->imagen;?>"/>
                              </div>
                            </div>
                            <?php    
                            }
                            ...
                            <div class="form-group">
                              <label for="imagen"><?php echo $label_fotografia; ?> </label>
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                  <div class="col-lg-3">    
                                  <?php
                                  if(set_value('estado', $testimonio->estado) == PUBLICADO)
                                      $class = 'btn-success';
                                  else
                                      $class='btn-danger'; 
                                  ...
                                  $opciones = array(
                                   ...
                                   echo form_dropdown($data, $opciones, set_value('estado',$testimonio->estado));
                                  ?> 
                                  </div>
                              </div>    
                            </div>                          
                          ...
                          <!-- /.box-body -->
                          <input type="hidden" name="imagen_thumb" id="imagen_thumb" value="<?php echo $testimonio->thumb;?>"/>                          
                          <input type="hidden" name="imagen" id="imagen" value="<?php echo $testimonio->imagen; ?>"/>
                          <input type="hidden" name="testimonio_id" id="testimonio_id" value="<?php echo $testimonio->id;?>" />
