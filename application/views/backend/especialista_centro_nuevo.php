    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form id="frm-maestra" role="form" method="post" action="<?php echo base_url('index.php/administrador/especialista/centro/guardar');?>">
            <div class="box-body">
              ...
              <div class="row" id="msg-existe-maestra" style="display: none;">
                <div class="col-md-6">
                  <div class="alert alert-warning" role="alert">La maestra constructora ya fue registrada en otro centro de formación, por favor verifique que los datos personales corresponden a la misma persona.</div>
                </div>
              </div>

              <div id="datos-complementarios">
                <div class="form-group">
                        ...
                        <div class="col-md-12">                        
                              <table class="table table-striped">
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <input type="text" class="form-control fecha-certificacion" name="fecha-certificacion[]" value="" placeholder="Ingrese una fecha" disabled="true"/>
                                  </td>
                                </tr>
                                <?php } ?>
                              </table>                          
            ...
            <input type="hidden" id="urlAjaxCi" value="<?php echo base_url('index.php/administrador/especialista'); ?>" />  
            <div class="box-footer">
              ...
              <a id="btn-editar" href="<?php echo base_url('index.php/administrador/especialista/centro/editar/'); ?>" class="btn btn-success" style="display: none;">Editar</a>
            </div>
          </form>
          <!-- form end -->                                   
        </div>
