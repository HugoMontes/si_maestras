        ...
        <form role="form" method="post" action="<?php echo base_url('index.php/administrador/especialista/centro/guardar');?>">
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">CERTIFICACIONES <?php echo strtoupper($centro->descripcion); ?></h3>
            </div>
                ...
                <div class="col-md-12">
                      <table class="table table-striped">
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="text" class="form-control fecha-certificacion" name="fecha-certificacion[]" value="<?php echo $valor_exp; ?>" placeholder="Ingrese fecha" <?php echo $activo?"":"disabled"; ?> >
                          </td>
                        </tr>
                        <?php } ?>
                      </table>                    
