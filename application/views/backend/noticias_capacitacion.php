...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('score_noticias_capacitacion');?>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
        ...
        <input type="hidden" name="accion_eliminar" id="accion_eliminar" value="<?php echo base_url('index.php/administrador/capacitacion/eliminar');?>" />
        <input type="hidden" name="accion_publicar" id="accion_publicar" value="<?php echo base_url('index.php/administrador/capacitacion/publicar');?>" />
        <input type="hidden" name="accion_publicar_mensaje" id="accion_publicar_mensaje" value="<?php echo base_url('index.php/administrador/capacitacion/publicar_mensaje');?>" />
                          ...
                          <div class="col-lg-4 margin-top-normal">
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <a id="buscar-titulo" href="" class="btn btn-primary" onclick="buscar_titulo('<?php echo base_url('index.php/administrador/capacitacion');?>');"><i class="fa fa-search"></i>&nbsp; Buscar</a>
                                </span>
                                <span class="input-group-btn">
                                    <a href="<?php echo base_url('index.php/administrador/capacitacion'); ?>" class="btn btn-default" style="margin-left: 10px;"> Limpiar</a>
                                </span>
                            </div>  
                        </div>
              ...
              <tbody>
                ...
                ?>
                    <tr class="<?php echo $sw_user?'':'not-active-row'; ?>">
                        <td class="row-title">
                            <a href="<?php echo base_url('index.php/administrador/capacitacion/editar/'.$noticia->id);?>" class="<?php echo $sw_user?'':'not-active-link'; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_editar_tooltip'); ?>"><?php echo $noticia->titulo?></a>
                        </td>
                        <td>
                            <?php
                        ...
                        <td style="text-align: center;">                      
                            <div class="btn-group">
                                <a href="<?php echo base_url('index.php/administrador/capacitacion/editar/'.$noticia->id);?>" class="btn btn-default <?php echo $sw_user?'':'not-active-link'; ?>" data-container="body" data-toggle="tooltip"  data-placement="top" title="<?php echo $this->lang->line('score_editar_tooltip'); ?>"><i class="fa fa-pencil"></i></a>
