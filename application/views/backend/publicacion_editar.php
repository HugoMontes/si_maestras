    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_publicacion_editar_titulo'); ?>
                        ...
                        <form role="form" enctype="multipart/form-data"  method="post" action="<?php echo base_url('index.php/administrador/publicacion/guardar');?>">
                          <div class="box-body">
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-6">                              
                                    <input type="text" class="form-control input-large-text" id="titulo" name="titulo" value="<?php echo set_value('titulo', $publicacion->titulo);?>" placeholder="Ingrese el título"/>
                                </div>
                              </div>      
                            </div>
                            
                            <div class="form-group">
                              <label for="resumen">Resumen de la publicación <span class="required">*</span></label>
                              <?php echo form_error('resumen', '<span class="error-form">', '</span><br/><br/>'); ?>
                              <textarea name="resumen" id="resumen"><?php echo set_value('resumen',$publicacion->resumen);?></textarea>
                            </div>  
                            ...
                            <div class="form-group">
                              ...
                              <textarea name="contenido" id="contenido"><?php echo set_value('contenido', $publicacion->contenido);?></textarea>
                            </div>                             
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-3">                              
                                    <input type="text" class="form-control" id="datepicker" name="fecha_publicacion" value="<?php echo set_value('fecha_publicacion', date('d-m-Y', strtotime($publicacion->fecha_publicacion)));?>" placeholder="día-mes-año"/>
                                </div>
                              </div>      
                            </div> 
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-6">                              
                                    <input type="text" class="form-control" id="fuente" name="fuente" value="<?php echo set_value('fuente',$publicacion->fuente);?>" placeholder="Ingrese la fuente de la publicación"/>
                                </div>
                              </div>      
                            </div>                                                                               
                            
                            <div class="form-group">
                              <label for="vista_previa">Imagen de portada</label>
                              <div class="margin-bottom">
                                  <img class="img-responsive img-centro" src="<?php echo base_url('assets/img/publicaciones/'.$publicacion->imagen); ?>" alt="<?php echo $publicacion->titulo;?>"/>
                              </div>
                            </div>
                            ...
                            <div class="form-group">
                              <label for="url">Url de descarga de publicación </label>
                              <?php echo form_error('url_descarga', '<span class="error-form">', '</span><br/><br/>'); ?>
                              <div class="row">
                                <div class="col-lg-6">                                    
                                    <input type="text" class="form-control" name="url_descarga" id="url_descarga" value="<?php echo set_value('url_descarga',$publicacion->url_descarga);?>" placeholder="http://"/>
                            ...
                            <div class="form-group">
                              ...
                              <div class="row">
                                <div class="col-lg-3"> 
                              <?php
                              if(set_value('estado', $publicacion->estado) == PUBLICADO)
                                  $class = 'btn-success';
                              else
                                  $class='btn-danger';                               
                              ...
                              $opciones = array(
                               ...
                               echo form_dropdown($data, $opciones, set_value('estado',$publicacion->estado));                               
                              ?>
                                </div>
                              </div> 
                            </div>                          
                          ...
                          <!-- /.box-body -->
                          <input type="hidden" name="imagen_thumb" id="imagen_thumb" value="<?php echo $publicacion->thumb;?>"/>
                          <input type="hidden" name="imagen" id="imagen" value="<?php echo $publicacion->imagen; ?>"/>
                          <input type="hidden" name="publicacion_id" id="publicacion_id" value="<?php echo $publicacion->id;?>" />
