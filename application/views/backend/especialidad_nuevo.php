...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      <?php echo $this->lang->line('caboco_especialidad_nuevo_titulo'); ?>
      <small></small>
    </h1>
  </section>
          ...
          <form role="form" method="post" action="<?php echo base_url('index.php/administrador/especialidad/guardar');?>">
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo set_value('descripcion');?>" placeholder="Ingrese nombre de una nueva especialidad"/>
                  </div>
                </div>      
              </div>
              <div class="form-group" style="display: none;">
                <label for="especialidad">Agregar antes de</label>
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    echo form_dropdown($data, $especialidades, set_value('especialidad'));                              
                    ?>  
                  </div>
                </div>      
              </div>
