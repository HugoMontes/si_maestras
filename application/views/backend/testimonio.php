              ...
              <div class="row">
                ...
                <!-- fin cuadro mensaje  -->                
                  <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form id="form-testimonio" role="form" enctype="multipart/form-data"  method="post" action="<?php echo base_url('index.php/administrador/testimonio/guardar');?>">
                          <div class="box-body">
                              ...
                              <div class="row">
                                  <div class="col-lg-6">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="tipo_nombre" name="tipo_nombre" value="" disabled="disabled"/>
