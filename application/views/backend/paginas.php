    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_paginas'); ?>
                <a href="<?php echo base_url('index.php/administrador/pagina/nuevo');?>" class="btn btn-default btn-sm title-action"><?php echo $this->lang->line('score_nueva'); ?></a>
                <small></small>
              </h1>
            </section>
            ...
            <section class="content">
              <div class="row">
                ...
                <input type="hidden" name="accion_eliminar" id="accion_eliminar" value="<?php echo base_url('index.php/administrador/pagina/eliminar');?>" />
                <input type="hidden" name="accion_publicar" id="accion_publicar" value="<?php echo base_url('index.php/administrador/pagina/publicar');?>" />
                <input type="hidden" name="accion_publicar_mensaje" id="accion_publicar_mensaje" value="<?php echo base_url('index.php/administrador/pagina/publicar_mensaje');?>" />
                  ...
                  <div class="box box-primary">
                              ...
                              <div class="col-lg-4 margin-top-normal">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <a id="buscar-titulo" href="" class="btn btn-primary" onclick="buscar_titulo('<?php echo base_url('index.php/administrador/pagina');?>');"><i class="fa fa-search"></i>&nbsp; Buscar</a>
                                    </span>
                                    <span class="input-group-btn">
                                        <a href="<?php echo base_url('index.php/administrador/pagina'); ?>" class="btn btn-default" style="margin-left: 10px;"> Limpiar</a>
                                    </span>
                                </div>  
                              </div>
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            <td class="row-title">
                                <a href="<?php echo base_url('index.php/administrador/pagina/editar/'.$pagina->id);?>" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_editar_tooltip'); ?>"><?php echo $pagina->titulo?></a>
                            </td>
                            <td>
                                <a href="<?php echo base_url('index.php/pagina/'.$pagina->alias);?>" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_ver_pagina_tooltip'); ?>" target="_blank"><?php echo 'index.php/pagina/'.$pagina->alias;?></a>
                            </td>
                            <td>
                            <?php
                            $autor = get_autor($pagina->creado_por); 
                            if(!empty($autor))
                            {
                            ?>
                                <a href="<?php echo base_url('index.php/administrador/usuario/editar/'.$pagina->creado_por);?>" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_autor'); ?>"><?php echo $autor?></a>
                            <?php
                            }
                            ?>
                            </td>
                            ...
                            <td style="text-align: center;">
                                <div class="btn-group">
                                    ...
                                    <a href="javascript:;" onclick="eliminar(<?php echo $pagina->id; ?>,'<?php echo $pagina->titulo; ?>')" class="btn btn-default" data-container="body" data-toggle="tooltip"  data-placement="top" title="<?php echo $this->lang->line('score_eliminar_tooltip'); ?>"><i class="fa fa-trash-o"></i></a>
                                </div>
                            </td>
                        </tr>
                        <?php
