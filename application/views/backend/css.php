    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                <?php echo $this->lang->line('score_css_editar_titulo');?>
                <small></small>
              </h1>
            </section>
            ...
            <section class="content">
              <div class="row">
                ...
                <div class="callout callout-info">
                    ...
                    <p><?php echo $this->lang->line('score_css_informacion');?></p>
                </div>
                <div class="callout callout-warning">
                    <p><?php echo $this->lang->line('score_css_advertencia');?></p>
                </div>                
                <?php    
                }?>
                <!-- fin cuadro mensaje  -->                
                  <div class="box box-primary">
                    <div class="box-header">
                      <h3 class="box-title">                        
                        Hoja de estilo (<?php echo $archivo;?>)
                        <small></small>
                      </h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                        <form id="template" role="form" method="post" action="<?php echo base_url('index.php/administrador/css/guardar');?>">
                          <div class="box-body">

                            <div class="form-group">
                              <textarea cols="70" rows="30" name="archivo_contenido" id="archivo_contenido"><?php echo set_value('contenido',$archivo_contenido);?></textarea>
                            </div>
