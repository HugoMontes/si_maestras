                        ...
                        ?>
                          <tr>
                            <td>
                              ...
                              <input type="text" class="form-control especialidad" name="especialidades[]" id="<?php echo $especialidad->id; ?>" value="<?php echo $especialidad->descripcion; ?>" placeholder="Ingrese nombre de la certificación">
                            ...
                            <td>
                              <?php
                                ...
                                echo form_dropdown($data, $areas, set_value('area',$especialidad->id_area));                              
                                ?>
