                  ...
                  <div class="col-md-6">
                    ...
                    <table>
                      <tr>
                        ...
                        <td>
                          No podrá eliminar el rubro de formación si el mismo está asociado a otros registros como "maestras constructuras" o "solicitud de servicios".
                        </td>
                      </tr>
                    </table>
                    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <table id="tbl-especialidades" class="table table-striped" style="margin: 0px;">
                      ...
                      <tr>
                        <td>
                          <input type="hidden" name="id_especialidades[]" value="<?php echo $especialidad->id; ?>">
                          <input type="text" class="form-control especialidad" name="especialidades[]" id="<?php echo $especialidad->id; ?>" value="<?php echo $especialidad->descripcion; ?>" placeholder="Ingrese nombre del rubro">
                        </td>
                        <td style="width: 50px;">
