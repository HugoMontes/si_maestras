...
<!-- fin de la cebecera -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('score_convocatoria_formador_nuevo_titulo');?>
      ...
      <?php echo $this->lang->line('score_convocatoria_formador_nuevo_ayuda');?>
      </div>        
      <!-- fin de ayuda --> 
    </section>
            ...
            <form method="post" action="<?php echo base_url('index.php/intranet/convocatoria_formador/guardar');?>">
              <div class="box-body">
                <div class="form-group">
                  <label for="nombre" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_convocatoria_formador_nombre');?>">Nombre <span class="required">*</span></label>
