...
<!-- fin de la cebecera -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('score_convocatoria_empresa_editar_titulo');?>
      ...
      <?php echo $this->lang->line('score_convocatoria_empresa_editar_ayuda');?>
      </div>        
      <!-- fin de ayuda --> 
    </section>
      ...
      <div class="row">      
        ...
        <!-- fin cuadro mensaje  -->           
         <div class="box box-primary">
           ...
           <!-- /.box-header -->
            <!-- form start -->
            <form method="post" action="<?php echo base_url('index.php/intranet/convocatoria_empresa/guardar');?>">
              <div class="box-body">

                <div class="form-group">
                  <label for="titulo" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_convocatoria_empresa_nombre');?>">Nombre <span class="required">*</span></label>
                ...
                <div class="form-group">
                  <label for="descripcion" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_convocatoria_empresa_descripcion');?>">Descripción</label>
                ...
                <div class="form-group">
                  <label for="estado" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_convocatoria_empresa_estado');?>">Estado</label>
