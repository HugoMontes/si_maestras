...
<!-- fin de la cebecera -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('score_biblioteca_categoria_editar_titulo');?>
      ...
      <?php echo $this->lang->line('score_biblioteca_categoria_editar_ayuda');?>
      </div>        
      <!-- fin de ayuda --> 
    </section>
            ...
            <form method="post" action="<?php echo base_url('index.php/intranet/biblioteca_categoria/guardar');?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="nombre" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_biblioteca_cat_nombre');?>">
                  Nombre <span class="required">*</span>
                  </label>
                  <?php echo form_error('nombre', '<span class="error-form">', '</span><br/>'); ?>
                  <div class="row">
                    <div class="col-lg-6"> 
                        <input type="text" class="form-control input-large-text" id="nombre" name="nombre" value="<?php echo set_value('nombre',$biblioteca_categoria->nombre);?>" placeholder="Ingrese el nombre"/>
                    </div>
                  </div>      
                </div>
                ...
                <!--<div class="form-group">
                  ...
                  <textarea name="descripcion" id="descripcion"><?php echo set_value('descripcion',$biblioteca_categoria->descripcion);?></textarea>
                </div>-->
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6"> 
                        <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo set_value('descripcion',$biblioteca_categoria->descripcion);?>" placeholder="Ingrese la descripción"/>
                    </div>
                  </div>      
                </div>  
                  ...
                  <label for="icono" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_biblioteca_cat_icono');?>">Icono </label>
                    <div class="row">
                      <div class="col-lg-3">
                        ...
                        <?php
                        if(empty($biblioteca_categoria->icono))
                            $icono_seleccionado = '';
                        else
                            $icono_seleccionado = set_value('icono', $biblioteca_categoria->icono);
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                      <div class="col-lg-3">    
                          ...
                          echo form_dropdown($data, $opciones, set_value('biblioteca_id',$biblioteca_categoria->biblioteca_id),'onChange="'.$onChange.'"');                               
                          ?>
                      <p class="help-block">Cambiar de biblioteca afecta a las subcategorías y documentos</p>                           
                      </div>
                  </div>        
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                      <div class="col-lg-3">    
                          ...
                          echo form_dropdown($data, $opciones, set_value('padre_id',$biblioteca_categoria->padre_id));                               
                          ?> 
                      </div>
                  </div>        
                </div>
                ...
                <div class="form-group">
                  ...
                  <?php //var_dump($hermanos); ?>
                  <?php echo form_error('orden', '<span class="error-form">', '</span><br/>'); ?>
                  <div class="row">
                      <div class="col-lg-3">  
                      <?php
                      $data = array(
                      ...
                      echo form_dropdown($data, $opciones, set_value('orden',$biblioteca_categoria->id)); 
                      ?> 
                      </div>
                  </div>    
                </div>                                                                          
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                      <div class="col-lg-3">  
                      <?php                                  
                      if(set_value('estado', $biblioteca_categoria->estado) == PUBLICADO)
                        $class = 'btn-success';
                      else
                        $class='btn-danger';  
                      ...
                      $opciones = array(
                       ...
                       echo form_dropdown($data, $opciones,set_value('estado',$biblioteca_categoria->estado));
              ...
              <!-- /.box-body -->
              <input type="hidden" name="biblioteca_categoria_id" id="biblioteca_categoria_id" value="<?php echo $biblioteca_categoria->id; ?>" />
