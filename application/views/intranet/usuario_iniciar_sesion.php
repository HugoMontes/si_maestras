...
<body class="hold-transition login-page" style="background-color: #2F4A9A;">
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url('index.php');?>">
        <img src="<?php echo base_url('assets/img/score_blanco.png'); ?>" />
    </a>
  </div>
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url('index.php/intranet/sesion/autenticar') ?>" method="post">
