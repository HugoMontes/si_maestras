...
<!-- fin de la cebecera -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('score_biblioteca_editar_titulo');?>
      ...
      <?php echo $this->lang->line('score_biblioteca_editar_ayuda');?>
      </div>        
      <!-- fin de ayuda --> 
    </section>
            ...
            <form method="post" action="<?php echo base_url('index.php/intranet/biblioteca/guardar');?>">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="titulo" data-html="true" data-toggle="tooltip" data-placement="top" title="<?php echo $this->lang->line('score_tp_biblioteca_nombre');?>">Nombre <span class="required">*</span></label>
                  <?php echo form_error('nombre', '<span class="error-form">', '</span><br/><br/>'); ?>
                  <div class="row">
                    <div class="col-lg-6"> 
                        <input type="text" class="form-control input-large-text" id="nombre" name="nombre" value="<?php echo set_value('nombre', $biblioteca->nombre);?>" placeholder="Ingrese el nombre"/>
                    </div>
                  </div>      
                </div>
                <div class="form-group">
                  ...
                  <textarea name="descripcion" id="descripcion"><?php echo set_value('descripcion',$biblioteca->descripcion);?></textarea>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-3">
                      <?php
                      if(set_value('estado', $biblioteca->estado) == PUBLICADO)
                          $class = 'btn-success';
                      else
                          $class='btn-danger';                               
                      ...
                      $opciones = array(
                       ...
                       echo form_dropdown($data, $opciones, set_value('estado',$biblioteca->estado));                               
                      ?>
                    </div>
                  </div> 
                </div>                        
              ...
              <!-- /.box-body -->
              <input type="hidden" name="biblioteca_id" id="biblioteca_id" value="<?php echo $biblioteca->id;?>" />
